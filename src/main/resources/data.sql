...
('http://localhost:8080/Sapito.jpg', true, 'Froggyfrogus'),
('http://localhost:8080/Apis mellifera.jpg', true, 'Apis mellifera'),
('http://localhost:8080/Cyanistes caeruleus.mp3', false, 'Cyanistes caeruleus'),
('http://localhost:8080/Cyanistes caeruleus.jpg', true, 'Cyanistes caeruleus'),
('http://localhost:8080/Cichorium intybus.jpg', true, 'Cichorium intybus')
;
